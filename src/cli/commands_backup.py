...
class RegScoutCommands:
    ...
    def init_comp        print(f"📋 Summary saved to: {summary_filename}")
        
    def _show_api_key_help(self):nts(self, collection_name: str = "regscout_documents",
    ...
    def _display_research_results(self, results: Dict):
        ...
        # Show saved report information
        if results.get('report_filename'):
            print(f"💾 Report saved: {results['report_filename']}")
